...
const Faq = () => {
    return (
        <div className='mt-20 mb-20'>
            ...
            <div className="w-full px-4 mb-20 md:flex gap-5">
                <div className=" md:w-1/2">
                    <div className='my-4'>
                        <Disclosure>
                            {({ open }) => (
                                <>
                                    <Disclosure.Button className="flex bg-primary-main w-full justify-between rounded-lg px-4 py-5 text-left text-sm font-semibold  hover:bg-primary-main focus:outline-none focus-visible:ring focus-visible:ring-purple-500/75">
                                    ...
                                    <Disclosure.Panel className="px-4 rounded-lg bg-primary-bg2 pb-2 pt-4 text-md text-primary-text ">
