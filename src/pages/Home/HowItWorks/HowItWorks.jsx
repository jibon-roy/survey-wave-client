                        ...
                        <div className="container mx-auto">
                            <div className="grid grid-cols-4 justify-between">
                                ...
                                <div className="py-2 px-4 col-span-3 max-md:col-span-4">
                                    <div className="max-md:border-x-2 md:border-l-2 bg-primary-bg2 hover:border-primary-text hover:bg-[#c2e2f3] transition border-primary-main p-6">
                                ...
                                <div className="py-2 px-4 col-span-3 max-md:col-span-4">
                                    <div className="max-md:border-x-2 md:border-r-2 bg-primary-bg2 hover:border-primary-text hover:bg-[#c2e2f3] transition border-primary-main p-6">
