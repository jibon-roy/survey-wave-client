...
const Cards = ({ data }) => {
    return (
        ...
        <div className="flex border-2 rounded-md border-primary-main h-full">
            <div className="p-4 flex flex-col text-center items-center">
                <div className="inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 flex-shrink-0">
                    <img src={data?.avatar} className="rounded-full w-28 h-28" alt="" />
                </div>
                <div className="flex-grow">
                    <h2 className="text-gray-900 text-xl text-primary-bg title-font font-medium mb-3">{data?.name}</h2>
