    ...
    createUserWithEmailPass(email, password)
      .then((result) => {
        if (result.user) {
          ...
          axiosPublic.post("/newUser", userData).then((res) => {
            if (res) {
              Swal.fire({
    ...
    <section className="text-gray-600 min-h-screen pb-5 body-font pt-10">
      ...
      <div className="container mx-auto -mt-5 md:flex items-center">
        <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
          ...
          <h1 className="title-font md:px-8 font-medium text-center text-3xl text-gray-900">
            Register for Free
          </h1>
          <p className="leading-relaxed md:px-8 text-center mt-4">
            Access your surveys and enjoy a seamless experience.
          </p>
          <Player
            autoplay
            loop
            src="https://lottie.host/607f50d6-38e7-4199-9f6b-1c729434495d/wBpgPkjgB4.json"
        ...
        <div className="lg:w-2/6 md:w-1/2 mb-20 mx-auto md:mr-4 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 border-2 border-primary-main md:mt-0">
          ...
          <div className="text-sm text-gray-500 mt-3">
            ...
            <div>
              <button
                onClick={gmailUser}
                className="w-full bg-gray-200 text-primary-text flex justify-center hover:bg-gray-300 border-0 py-2 px-8 focus:outline-none rounded gap-2 my-5 text-lg"
              >
                Continue with<FcGoogle className="text-3xl"></FcGoogle>
              </button>
            </div>
          </div>
        </div>
